...
if(stripos($_SERVER["REQUEST_URI"],'confirmation_commande.php')){
    echo("<link rel='stylesheet' href='/~XAMMM/styles/panier.css' />\n");
}
    ...
    <header id='header'>
        <ul id='headerMenusWrapper'>
            ...
            <ul class='headerMenu textTitleMenu'>
                <span class='headerMenuTitle'>Nos activités</span>
