...
if (!empty($_POST["lastName"])&&!empty($_POST["firstName"])&&!empty($_POST["mail"])&&!empty($_POST["password"])&&!empty($_POST["phoneNum"])&&!empty($_POST["height"])&&!empty($_POST["weight"])&&!empty($_POST["age"])){

    $res = CreateUser($conn, $lastName, $firstName, $mail, $password, $phoneNum, $height, $weight, $age, $admin);
